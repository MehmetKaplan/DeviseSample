...
7. To use SSL
	...
	- If you are using devise, add these lines to ```config/environments/development.rb```, ```config/environments/production.rb```, ```config/environments/test.rb```:
	```Ruby
	...
	- Either you use devise or not, add these lines to ```config/environments/development.rb```, ```config/environments/production.rb```, ```config/environments/test.rb```:
	```Ruby
